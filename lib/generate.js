...
var defaultVersion = 'MQIsdp',
	defaultVersionNum = 3,
	defaultKeepalive = 60,
	defaultClient = 'mqtt_' + process.pid;
...
module.exports.connect = function(opts) {
	...
	flags |= (typeof willTopic !== 'undefined' && typeof willPayload !== 'undefined') ? protocol.WILL_FLAG_MASK : 0;
	...
	if(flags & protocol.WILL_FLAG_MASK) packet.payload = packet.payload.concat(gen_string(willPayload));
