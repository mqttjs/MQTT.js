...
function MqttClient (streamBuilder, options) {
  ...
  // Is the internal stream setup?
  this.streamIsSetup = false
  ...
  if (!this.options.delayConnection) {
    this._setupStream()
  }
}
...
/**
 * startConnection - start the connection if it has been delayed in the constructor
 *
 * @returns {MqttClient} this - for chaining
 *
 * @api public
 */
MqttClient.prototype.startConnection = function () {
  if (!this.streamIsSetup) {
    this._setupStream()
  }
