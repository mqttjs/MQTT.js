...
class MqttClient extends EventEmitter {
	...
	constructor(streamBuilder, options) {
		...
		this.log(
			...
			options.properties ? options.properties.topicAliasMaximum : undefined,
		)

		this.options.clientId =
			typeof options.clientId === 'string' ? options.clientId : MqttClient.defaultId()
	...
	_resubscribe() {
		...
		if (
			...
			(this.options.clean ||
				(this.options.protocolVersion === 5 && !this.connackPacket.sessionPresent)) &&
