...
MqttClient.prototype._handleConnack = function (packet) {
  ...
  if (packet.properties) {
    if (packet.properties.topicAliasMaximum && this.options.properties.topicAliasMaximum) {
      this.options.properties.topicAliasMaximum = packet.propperties.topicAliasMaximum
    }
...
MqttClient.prototype._handleAck = function (packet) {
  ...
  switch (type) {
    ...
    case 'puback':
      var pubackRC = packet.responseCode
      // Callback - we're done
      delete this.outgoing[mid]
    ...
    case 'pubrec':
      ...
      var pubrecRC = packet.responseCode
