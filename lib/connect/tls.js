...
function buildBuilder (mqttClient, opts) {
  ...
  // If a explicit local address has been provided
  if(opts.localAddress)
  {
    // Use this socket rather than tls.connect() making a new one. Here we
    // force the value of localAddress. See api/tls.htm and /api/net.html
    opts.socket = net.connect(opts);
  }
